...
# Characterizing Government Responces
...
We also utilized interaction terms to see whether the characteristics of a particular policy changes the effect on the outcome (reproduction rate and death per capita)

<br>

## Reproduction Rate of COVID-19
As seen in our previous graphic, the reproduction rate of COVID-19 is essentially the spreadability of the virus.

It is the average number of secondary cases produced by a primary case.

It may be greater than one when the number of infected individuals is increasing.
